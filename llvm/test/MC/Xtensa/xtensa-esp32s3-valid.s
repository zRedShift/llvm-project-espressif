...
# CHECK: ee.ldf.128.ip	 f3, f5, f8, f0, a13, 64 # encoding: [0x0d,0x80,0x35,0x10]
...
# CHECK: ee.ld.128.usar.ip	 q4, a8, -592   # encoding: [0x84,0x30,0xe1]
ee.ld.128.usar.xp q1, a9, a7
# CHECK: ee.ld.128.usar.xp	 q1, a9, a7     # encoding: [0x94,0x87,0x8d]
ee.ld.accx.ip a2, 720
# CHECK: ee.ld.accx.ip	 a2, 720                # encoding: [0x24,0x50,0x4e]
ee.ld.qacc_h.h.32.ip a6, -292
# CHECK: ee.ld.qacc_h.h.32.ip	 a6, -292       # encoding: [0x64,0x5c,0x5e]
ee.ld.qacc_h.l.128.ip a14, 96
# CHECK: ee.ld.qacc_h.l.128.ip	 a14, 96        # encoding: [0xe4,0x60,0x06]
ee.ld.qacc_l.h.32.ip a0, -184
# CHECK: ee.ld.qacc_l.h.32.ip	 a0, -184       # encoding: [0x04,0x48,0x16]
ee.ld.qacc_l.l.128.ip a5, -352
# CHECK: ee.ld.qacc_l.l.128.ip	 a5, -352       # encoding: [0x54,0x20,0x40]
ee.ld.ua_state.ip a3, 864
# CHECK: ee.ld.ua_state.ip	 a3, 864        # encoding: [0x34,0x60,0x10]
...
# CHECK: ee.src.q.ld.ip	 q2, a2, 1792, q6, q7   # encoding: [0x02,0x87,0x05,0x1c]
...
# CHECK: ee.stf.128.ip	 f4, f3, f8, f2, a4, -128 # encoding: [0x04,0x82,0x43,0x12]
...
# CHECK: ee.stf.64.ip	 f3, f6, a10, -848      # encoding: [0x6a,0x36,0x58,0x1c]
...
# CHECK: ee.st.accx.ip	 a10, 24                # encoding: [0xa4,0x18,0x02]
ee.st.qacc_h.h.32.ip a14, 380
# CHECK: ee.st.qacc_h.h.32.ip	 a14, 380       # encoding: [0xe4,0x7c,0x12]
ee.st.qacc_h.l.128.ip a7, -624
# CHECK: ee.st.qacc_h.l.128.ip	 a7, -624       # encoding: [0x74,0x10,0x4d]
ee.st.qacc_l.h.32.ip a10, -20
# CHECK: ee.st.qacc_l.h.32.ip	 a10, -20       # encoding: [0xa4,0x6c,0x5d]
ee.st.qacc_l.l.128.ip a4, 1936
# CHECK: ee.st.qacc_l.l.128.ip	 a4, 1936       # encoding: [0x44,0x10,0x4c]
ee.st.ua_state.ip a4, -1728
# CHECK: ee.st.ua_state.ip	 a4, -1728      # encoding: [0x44,0x40,0x1c]
...
# CHECK: ee.vldbc.16.ip	 q6, a4, 124            # encoding: [0x44,0x7c,0xb5]
...
# CHECK: ee.vldbc.32.ip	 q6, a12, 308           # encoding: [0xc4,0x34,0xb2]
...
# CHECK: ee.vmulas.s16.accx.ld.ip	 q7, a7, -16, q2, q0 # encoding: [0x07,0x80,0xf0,0x1f]
ee.vmulas.s16.accx.ld.ip.qup q5, a14, 32, q0, q2, q0, q2
# CHECK: ee.vmulas.s16.accx.ld.ip.qup	 q5, a14, 32, q0, q2, q0, q2 # encoding: [0x0e,0x10,0x54,0x01]
...
# CHECK: ee.vmulas.s16.qacc.ld.ip	 q7, a7, -64, q7, q7 # encoding: [0x07,0xf8,0x73,0x1e]
ee.vmulas.s16.qacc.ld.ip.qup q0, a10, 48, q3, q6, q3, q6
# CHECK: ee.vmulas.s16.qacc.ld.ip.qup	 q0, a10, 48, q3, q6, q3, q6 # encoding: [0x0a,0xf3,0x8c,0x03]
...
# CHECK: ee.vmulas.s8.accx.ld.ip	 q2, a8, 80, q3, q0 # encoding: [0x08,0xc0,0xa4,0x1e]
ee.vmulas.s8.accx.ld.ip.qup q2, a9, -80, q1, q2, q6, q3
# CHECK: ee.vmulas.s8.accx.ld.ip.qup	 q2, a9, -80, q1, q2, q6, q3 # encoding: [0x09,0x56,0xa6,0x05]
...
# CHECK: ee.vmulas.s8.qacc.ld.ip	 q5, a10, -16, q0, q0 # encoding: [0x0a,0x00,0xd6,0x1f]
ee.vmulas.s8.qacc.ld.ip.qup q7, a9, -48, q6, q2, q1, q2
# CHECK: ee.vmulas.s8.qacc.ld.ip.qup	 q7, a9, -48, q6, q2, q1, q2 # encoding: [0x09,0x91,0xf5,0x06]
...
# CHECK: ee.vmulas.u16.accx.ld.ip	 q5, a8, -32, q1, q4 # encoding: [0x08,0x60,0x58,0x1f]
ee.vmulas.u16.accx.ld.ip.qup q1, a0, 48, q7, q4, q4, q0
# CHECK: ee.vmulas.u16.accx.ld.ip.qup	 q1, a0, 48, q7, q4, q4, q0 # encoding: [0x00,0xe4,0x91,0x09]
...
# CHECK: ee.vmulas.u16.qacc.ld.ip	 q4, a10, 16, q3, q2 # encoding: [0x0a,0xd0,0xca,0x1e]
...
# CHECK: ee.vmulas.u8.accx.ld.ip	 q6, a3, -112, q2, q7 # encoding: [0x03,0xb8,0xec,0x1e]
ee.vmulas.u8.accx.ld.ip.qup q7, a3, -32, q3, q3, q7, q5
# CHECK: ee.vmulas.u8.accx.ld.ip.qup	 q7, a3, -32, q3, q3, q7, q5 # encoding: [0x03,0xdf,0x7a,0x0d]
...
# CHECK: ee.vmulas.u8.qacc.ld.ip	 q2, a12, 32, q1, q4 # encoding: [0x0c,0x60,0x2e,0x1f]
ee.vmulas.u8.qacc.ld.ip.qup q0, a6, 48, q0, q0, q6, q0
# CHECK: ee.vmulas.u8.qacc.ld.ip.qup	 q0, a6, 48, q0, q0, q6, q0 # encoding: [0x06,0x06,0x80,0x0f]
